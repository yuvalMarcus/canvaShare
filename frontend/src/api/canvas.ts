...
export const getCanvas = async (id?: number): Promise<axios.AxiosResponse> => {
    const res = await instance.get(`canvas/${id}`);
    return res.data;
}

export const getCanvases = async (params): Promise<axios.AxiosResponse> => {
...
export const createCanvas = async (payload: CanvasPayload): Promise<axios.AxiosResponse> => {
    return await instance.post('canvas', payload);
}

export const updateCanvas = async (id: number, payload: CanvasPayload): Promise<axios.AxiosResponse> => {
    return await instance.put(`canvas/${id}`, payload);
}

export const deleteCanvas = async (id: number): Promise<axios.AxiosResponse> => {
